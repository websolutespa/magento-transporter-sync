...
class Stock extends Action implements HttpGetActionInterface
{
    /**
     * @var string
     */
    protected const TYPE = 'silicon_stock_specific';
    ...
    public function execute(): Redirect
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('Stock Sync Complete.'));
        } catch (Exception $e) {
